				...
				<div class="relative flex justify-between h-24">
					...
					<div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0" x-data="{ show: false }">
						<div class="hidden lg:flex sm:space-x-4 ">
							...
							<a href="{{ url('sectors/commercial') }}" class="text-gray-200 hover:text-sky-500 px-3 py-2 rounded-md text-sm font-semibold uppercase transition duration-300">Commercial</a>
							<a href="{{ url('sectors/residential') }}" class="text-gray-200 hover:text-sky-500 px-3 py-2 rounded-md text-sm font-semibold uppercase transition duration-300">Residential</a>
							<a href="{{ url('sectors/people') }}" class="text-gray-200 hover:text-sky-500 px-3 py-2 rounded-md text-sm font-semibold uppercase transition duration-300">People</a>
